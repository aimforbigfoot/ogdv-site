    ...
    <div class="pa4-l pb4 mb7">
        <div class="bg-light-red mw7 center pa4 br2-ns ba b--black-10">
            ...
            <section class="cf bn ma0 pa0">
                ...
                <h1 class="pa0 f1 tc fw7 ma0 pa0 mb3 black-80">Sign up for our newsletter</h1>
                <div class="cf">
                    <label class="clip" for="email-address">Email Address</label>
                    <input on:keyup={(e) => handleInputForEmailSub(e)} class="f6 f5-l input-reset bn fl black-80 bg-white pa3 lh-solid w-100 w-75-m w-80-l br2-ns br--left-ns" placeholder="Your Email Address" type="text" name="email-address" bind:value={userEmail} >
